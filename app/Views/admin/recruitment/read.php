        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="recruitment-meta">
                            ...
                            <div class="meta-item">
                                ...
                                <div class="meta-content">
                                    ...
                                    <div class="meta-value"><?= ucwords(htmlspecialchars($recruitment['kategori'] ?? 'asisten lab')) ?></div>
                                </div>
                            </div>
                            ...
                            <div class="meta-item">
                                ...
                                <div class="meta-content">
                                    ...
                                    <div class="meta-value"><?= htmlspecialchars($recruitment['periode'] ?? '-') ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php if (!empty($recruitment['banner_image'])): ?>
                    ...
                    <div class="banner-section" style="margin-bottom: 2rem;">
                        ...
                        <img src="<?= upload_url('recruitment/' . $recruitment['banner_image']) ?>" alt="Banner" style="max-width: 100%; border-radius: 8px; border: 1px solid var(--color-gray-200);">
                    </div>
                <?php endif; ?>
