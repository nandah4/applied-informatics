        ...
        <div class="page-header-list">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="page-subtitle">Kelola data pendaftar Asisten Laboratorium Applied Informatics</p>
                </div>
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        <h6>Tidak ada data pendaftar</h6>
                                        <p>Mulai dengan membuka rekrutmen di <a style="text-decoration: underline;" href="<?= base_url("admin/recruitment") ?>">Rekrutmen</a></p>
                                    </div>
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($listPendaftar as $dt): ?>
                                <tr>
                                    <td class="col-id"><?= $dt['id'] ?></td>
                                    <td class="col-id"><?= $dt['rekrutmen_id'] ?></td>
                                    <td class="col-status">
                                        <?php
                                        $badgeClass = 'badge-warning';
                                        if ($dt['status_seleksi'] === 'Diterima') {
                                            $badgeClass = 'badge-success';
                                        } elseif ($dt['status_seleksi'] === 'Ditolak') {
                                            $badgeClass = 'badge-danger';
                                        }
                                        ?>
                                        <span class="badge-custom <?= $badgeClass ?>"><?= htmlspecialchars($dt['status_seleksi']) ?></span>
                                    </td>
                                    <td class="col-posisi"><?= htmlspecialchars($dt['nim']) ?></td>
                                    <td class="col-posisi">
                                        <div style="font-weight: 600; color: var(--color-gray-900);"><?= htmlspecialchars($dt['nama']) ?></div>
                                    </td>
