...
<head>
    ...
    <!-- Aktivitas Page CSS -->
    <link rel="stylesheet" href="<?= asset_url('css/pages/aktivitas-lab/index.css') ?>">
</head>
...
<body>
                                ...
                                <tr>
                                    ...
                                    <td class="action-cell">
                                        <div class="action-buttons">
                                            ...
                                            <button class="btn-action btn-delete" title="Hapus" onclick="confirmDelete(<?= $aktivitas['id'] ?>, '<?= htmlspecialchars($aktivitas['judul_aktivitas']) ?>')">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        <h6>Tidak ada data aktivitas</h6>
                                        <p>Mulai dengan menambahkan aktivitas pertama Anda</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
    ...
    <script src="<?= asset_url('js/pages/aktivitas-lab/index.js') ?>"></script>
