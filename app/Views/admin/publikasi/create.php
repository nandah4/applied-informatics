...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <h1 class="page-title">Tambah Publikasi</h1>
            <p class="page-subtitle">Tambahkan data publikasi dosen ke sistem</p>
        </div>
                ...
                <form id="formPublikasi" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="judul" name="judul" rows="3" placeholder="Masukkan judul publikasi" required></textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="tahun_publikasi" name="tahun_publikasi" placeholder="Contoh: 2024" min="1900" max="2100">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" id="btn-submit-create-publikasi" class="btn-primary-custom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
